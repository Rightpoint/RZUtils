...
typedef NS_ENUM(NSInteger, RZValidationType)
{
...
@property (assign, nonatomic) RZValidationType validationType;
@property (strong, nonatomic) NSDictionary *validationConditions;
...
- (BOOL)isValidForString:(NSString *)str
{
    ...
    if ( self.validationType == RZValidationTypeDictionary ) {
        ...
        for ( NSString *key in allKeys ) {
            if ( [key isEqualToString:kFieldValidationRegexKey] ) {
